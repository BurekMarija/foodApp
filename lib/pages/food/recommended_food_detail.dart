...
import '../../controllers/cart_controler.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: GetBuilder<PopularProductController>(builder:(controller){
        return Column(
        mainAxisSize: MainAxisSize.min, //bez toga column zauzme čitav ekran
        children: [
          Container(
